...
{
    public class WrappedAsyncQueryProvider : IQueryProvider, IWrappedAsyncQueryProvider, IDbAsyncQueryProvider
    {
        ...
        public Task<TResult> ExecuteAsync<TResult>(Expression expression, CancellationToken token)
        {
            ...
            {
                var visitor = new WrappedAsyncExpressionVisitor(this);
            ...
            //}
            return ((System.Data.Entity.Infrastructure.IDbAsyncQueryProvider)SourceProvider).ExecuteAsync<TResult>(expression, token);
        }
