    ...
    public static class DomainEntityFrameworkCoreExtensions
    {
            ...
            where TDbContext : DbContext
        {
            ...
            foreach (var property in properties)
            {
                ...
                var func = (Func<IServiceProvider, object>)Delegate.CreateDelegate(typeof(Func<IServiceProvider, object>), typeof(DatabaseContext<TDbContext>).GetMethod("GetEntityContextDelegate", BindingFlags.Public | BindingFlags.Static).MakeGenericMethod(type));
