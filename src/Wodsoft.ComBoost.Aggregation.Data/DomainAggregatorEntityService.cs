...
namespace Wodsoft.ComBoost.Aggregation.Data
{
        ...
        where TEntity : class, IEntity
    {
        ...
        public async Task<T?> GetAsync(string[] keys)
        {
            ...
            return await _entityContext.Query().Where(predicate).ProjectTo<T>(_mapper.ConfigurationProvider).FirstOrDefaultAsync();
        }
    }
}
