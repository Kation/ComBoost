(function ($) {
    ...
    $.Dialog = function (params) {
        ...
        if (params.sysButtons) {
            ...
            if (params.sysButtons.btnOK) {
                $("<button>" + params.sysButtons.btnOKText + "</button>").on('click', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
            ...
            if (params.sysButtons.btnCancel) {
                $("<button>" + params.sysButtons.btnCancelText + "</button>").on('click', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
    ...
    $.Dialog.footer = function (newFooter) {
